package com.creatokids.hajwithibraheem.Global;//package com.creatokids.hajwithibraheem.Global;
//
///**
// * Created by Creato on 26/02/2018.
// */
//
//
...
//            logMessage(tag, "Root cause (" + (i + 1) + " of " + size + ")" + causes.get(i));
//        }
//    }
//
